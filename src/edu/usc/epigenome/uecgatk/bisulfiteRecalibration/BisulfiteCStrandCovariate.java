/**
 * measure possible strand bias of bisulfite-seq, put read into bisulfiteC strand as "C"  by C or T's base number in the reads is bigger than expectation. Expectation=readLen*0.25
 */
...
public class BisulfiteCStrandCovariate implements StandardCovariate {
	...
	/* (non-Javadoc)
	 * @see org.broadinstitute.sting.gatk.walkers.recalibration.Covariate#initialize(org.broadinstitute.sting.gatk.walkers.recalibration.RecalibrationArgumentCollection)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.broadinstitute.sting.gatk.walkers.recalibration.Covariate#getValue(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.broadinstitute.sting.gatk.walkers.recalibration.Covariate#getValues(org.broadinstitute.sting.utils.sam.GATKSAMRecord, java.lang.Comparable[])
	 */
