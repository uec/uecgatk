...
@DocumentedGATKFeature(
        groupName = "BisulfiteAnalyzeCovariates",
...
public class BisulfiteAnalyzeCovariates extends CommandLineProgram {
    ...
    /////////////////////////////
    private BisulfiteAnalysisDataManager dataManager; // Holds the data HashMap, mostly used by TableRecalibrationWalker to create collapsed data hashmaps
