...
public class NOMeSeqReads extends cpgReads {
	 ...
	 * @param readID
	 */
	public NOMeSeqReads(String chr, int genomeLoc, char methyStatus,
			byte baseQ, char strand, String readID) {
		super(chr, genomeLoc, methyStatus, baseQ, strand, readID);
		// TODO Auto-generated constructor stub
	}
	
	public NOMeSeqReads(String chr, int genomeLoc, String sampleContext, String refContext, char methyStatus,
			byte baseQ, char strand, String readID) {
		super(chr, genomeLoc, methyStatus, baseQ, strand, readID);
