/**
 * basically, it is just copie from GATK. but have a few adaptations to bisulfite-seq.  add 6th state, which is X in bisulfite space when reference is C, base is T..
 */
...
import org.broadinstitute.sting.utils.baq.BAQ.BAQCalculationResult;
